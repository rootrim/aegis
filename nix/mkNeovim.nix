...
devPlugins ? [ ], ignoreConfigRegexes ? [ ], extraPackages ? [ ]
, extraLuaPackages ? p: [ ], extraPython3Packages ? p: [ ], withPython3 ? true
, withRuby ? false, withNodeJs ? false, withSqlite ? true
, viAlias ? appName == null || appName == "nvim"
, vimAlias ? appName == null || appName == "nvim", wrapRc ? true, }:
let
  defaultPlugin = {
    plugin = null;
    config = null;
  ...
  '' + (builtins.readFile ../nvim/init.lua) + optionalString (devPlugins != [ ])
    (''
  ...
  ((optional (appName != "nvim" && appName != null && appName != "")
    ''--set NVIM_APPNAME "${appName}"'') ++ (optional (externalPackages != [ ])
...
in neovim-wrapped.overrideAttrs (oa: {
  buildPhase = oa.buildPhase + lib.optionalString isCustomAppName ''
